...
const Register = () => {
  ...
  const onSignUpPress = async () => {
    ...
    try {
      console.log('hi', emailAddress,password );
      await signUp.create({
        emailAddress,
        password
      })
console.log('hlo');
  ...
  return (
    <View style={styles.container}>
      ...
      {!pendingVerification && (
        <>
          <TextInput autoCapitalize="none" placeholder="vaibhavp@zignuts.com" value={emailAddress} onChangeText={setEmailAddress} style={styles.inputField} />
